...
Para este proyecto se proporciona la versión secuencial matvec.c del producto matriz-vector w = Av de una matriz banda cuadrada A ∈ R^N×N con ancho de banda b. La estructura banda de la matriz se refiere a que el elemento aij es cero si |i − j| > b.
...
El producto matriz-vector es la operación básica utilizada en muchos métodos iterativos para diferentes problemas de álgebra lineal. En estos métodos se repite la operación de producto matriz-vector muchas veces.
Para simplificar, en nuestro caso vamos a analizar las prestaciones de un bucle simple que ejecute el producto matriz-vector (secuencial o paralelo) un número determinado de veces, por ejemplo 1000 o 10000.
